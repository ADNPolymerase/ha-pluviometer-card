...
- **Collapsible 24 h history**: enable `show_history` and the card gets a discreet button that expands a 24 h chart of the sensor (step trace, drawn with the water color, data from the HA history API).
