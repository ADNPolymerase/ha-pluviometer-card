...
- **Tracé 24 h dépliable** : avec `show_history`, la card gagne un bouton discret qui déroule un graphique des dernières 24 h du capteur (tracé en escalier, couleur de l'eau, données via l'API history de HA).
